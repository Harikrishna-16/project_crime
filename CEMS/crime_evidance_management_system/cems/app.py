...
host = "OCDB.APP"
port = 5050
database = "db_437jwcjev" # your database
username = "user_437jwcjev" # your username
password = "p437jwcjev" # your password
...
SENDER_PASSWORD =  "kbkz ygyb zkkz eyfx"
...
higher_credentials={"100":{"Name":"swaroop","password":"police@123"},
                    "101":{"Name":"AKHIL","password":"swaroop@123"},
...
lower_credentials={"10":{"Name":"AKHIL","password":"tiru@123"},
                   "11":{"Name":"AKHIL","password":"ashok@123"},
                    "581":{"Name":"swaroop","password":"swaroop@123","Email":"swaroopedupulapati1@gmail.com","phone_no":"9999999999","Address":"marlapadu","Qualification":"btech"}}
...
def edit_case():
    if request.method == 'POST':
        ...
        for i in range(len(labels)):
            ...
            case_details.append(detail)
        recipient_email = "22491A0538@qiscet.edu.in"
